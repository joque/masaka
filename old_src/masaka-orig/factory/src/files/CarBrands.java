...
public class CarBrands extends JInternalFrame implements ActionListener
{
    ...
    CarBrands(String whichOne,JFrame getParentFrame)
    {
       ...
       tbCustomer = new JTable( dtmCustomer )
        ...
        setSize((screen.width/3), ((screen.height*2)/3) );
